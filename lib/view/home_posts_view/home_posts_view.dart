                  ...
                  onTap: () {
                    AppNavigation().pushDownToUp(
                      ...
                      PostDetailsView(
                        ...
                        profileImage: postsModel[index].userImage!,
                        datePost: postsTime(postsModel[index].shareTime!),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                CustomText(
                                  text: postsModel[index].name!,
                                  fontsize: 16,
                                  textfield: true,
                                ),
                                CustomText(
                                  text: postsTime(postsModel[index].shareTime!),
                                  fontsize: 10,
                                  textfield: true,
                                  color:
                      ...
                      Expanded(
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              postsModel[index].image.toString(),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
