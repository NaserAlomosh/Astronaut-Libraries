...
class _AddLibraryViewState extends State<AddLibraryView> {
  TextEditingController lipraryNameController = TextEditingController();
  TextEditingController confirmlipraryNameController = TextEditingController();
  TextEditingController githubUrlController = TextEditingController();
  TextEditingController pubDevUrlController = TextEditingController();
    ...
    return BlocProvider(
      ...
      child: Stack(
        children: [
          ...
          BlocConsumer<AddLibraryCubit, AddNewLibState>(
            listener: (context, state) {},
            builder: (context, state) {
              if (state is AddNewLoadingState) {
                return Center(
